...
function initialize(box)
	...
	dofile(box:get_config("${Path_Data}") .. "/lua-stimulator-stim-codes.lua")
...
function process(box)
	...
	while box:keep_processing() do
		for stimulation = 1, box:get_stimulation_count(1) do
				...
				-- delay the OOVTK_StimulationId_Label_01 (close) and OVTK_StimulationId_Label_02 (open)
				if identifier == OVTK_StimulationId_Label_01 or identifier == OVTK_StimulationId_Label_02 then
