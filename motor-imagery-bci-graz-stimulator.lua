...
function initialize(box)
	...
	box:log("Info", string.format("cue duration %f", display_cue_duration))
...
function process(box)
	box:log("Trace", "PROCESSa") 
	box:log("Info", "PROCESSa")  
	...
	for i = 1, number_of_trials*2 do
		...
		-- display image based on the class
		box:log("Info", string.format("Empiezo en t=%f", t))
		...
		box:log("Info", string.format("Acabo en t=%f", t))
